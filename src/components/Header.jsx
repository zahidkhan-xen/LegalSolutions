...
const Header = () => {
  ...
  const[ isVoiceOpen, setIsVoiceOpen] = useState(false); // Voice state
    ...
    <header className="header py-20 text-center md:pt-36  lg:text-center xl:pt-44 xl:pb-32">
      <div className="sm:px-8 lg:grid lg:gap-x-8">
        ...
        Automate Your Contract Reviews with AI
          ...
          <h2 className="font-medium text-xl sm:text-2xl lg:text-2xl mb-4">
        ...
        <div className="flex flex-col justify-center text-left sm:text-center md:text-left lg:text-left xl:mr-12">
          <ul className="lg:list-disc">
            <li>
              ...
              Automate tedious contract reviews              </h1>
            </li>
            <li>
              <h1 className="font-medium text-xl mb-5">
              Improve client engagement with AI voice agents
              </h1>
            </li>
            <li>
              <h1 className="font-medium text-xl mb-5">
      ...
      {isVoiceOpen && <ReservationForm isVoiceOpen={isVoiceOpen} onClose={closeVoiceModal} />}
    </header>
  );
};
